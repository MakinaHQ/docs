...
| `INFRA_CONFIG_ROLE`                | 1   | Configure shared core contracts (e.g. [oracle](../oracles) feed routes, chain/token mappings).                                                 | DAO: 1-day delay                                        |
...
| `STRATEGY_FEE_CONFIG_ROLE`         | 5   | Configure [fee](../machine/fees) parameters in periphery contracts.                                                                            | DAO: 2-day delay                                        |
...
| Entity                                   | Scope                                                                                                                                                                                                                   |
| ---------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[Operator](operator)**                 | Day-to-day execution: position management, harvesting, swaps, and cross-chain transfers. Settles the [redemption queue](../machine/redemptions). _(On-chain: the `mechanic` address.)_                                  |
