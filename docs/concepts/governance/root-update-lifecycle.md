...
1. In the public [`makina-integrations`](https://github.com/MakinaHQ/makina-integrations) repository, the Operator will submit a PR with the updated root and corresponding instructions. This update will be reviewed by at least two entities: the Security Council and Makina developers.
