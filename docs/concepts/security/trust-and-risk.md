...
| **End users**                                                                                            | Untrusted         | Hold and transfer share tokens only. They have no execution rights in the core contracts, and interact through the Depositor and Redeemer rather than the Machine directly.                                                                                                                                                                                                                                                                                  |
