...
Each Strategy is composed of a [Machine](Machine/machine-overview) deployed on the Hub Chain, and one [Caliber](Caliber/caliber-overview) per supported chain (including the Hub and each Spoke Chain).
