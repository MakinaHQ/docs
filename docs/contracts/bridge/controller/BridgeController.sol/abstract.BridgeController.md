...
**Inherits:**
AccessManagedUpgradeable, [MakinaContext](/src/utils/MakinaContext.sol/abstract.MakinaContext.md), [IBridgeController](/src/interfaces/IBridgeController.sol/interface.IBridgeController.md)
...
Bridge ID => Max allowed value loss in basis points for an outgoing transfer.
...
|`initialMaxBridgeLossBps`|`uint256`|The initial maximum allowed value loss in basis points for outgoing transfers via this bridge.|
