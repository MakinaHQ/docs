...
**Inherits:**
AccessManagedUpgradeable, [MakinaContext](/src/utils/MakinaContext.sol/abstract.MakinaContext.md), [IPreDepositVault](/src/interfaces/IPreDepositVault.sol/interface.IPreDepositVault.md)
