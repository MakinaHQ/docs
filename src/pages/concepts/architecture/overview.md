...
These are covered in [Pricing & Oracles](pricing-oracles) and the [Contracts](/contracts/core/architecture-overview) reference.
...
| **Hub Chain**             | The chain a strategy's Machine lives on, where users deposit and redeem. Each Makina instance has one hub chain.                                                                                                                                                                                                                                                                  |
