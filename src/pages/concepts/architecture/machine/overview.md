...
You can see the accounting token (and all other contracts) for each live strategy on the [Strategies](../../../strategies/deployments.mdx) page or in the [Makina app](https://makina.finance/explore).
