...
- **Wormhole.** [Cross-chain AUM](../architecture/cross-chain/cross-chain-accounting) is relayed from spokes via messages signed by Wormhole guardians. The system trusts that at least two-thirds of the guardian set is honest and signs only valid, untampered messages.
